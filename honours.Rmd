...
Importing Raw Evoked Current Data
```{r}
eEPSC_data <- read.csv("Data/raw.csv")
...
first_time_df <- add_new_cells(
  new_raw_data_csv = "Data/raw.csv", #eEPSC raw data just imported
...
```{r eval=FALSE}
# will not run if there is nothing new in "raw_eEPSC_df.csv" so if you put new data directly into that, won't run
add_new_cells(
  new_raw_data_csv = "Data/raw_eEPSC_df.csv",
