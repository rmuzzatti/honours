...
acute_female_AP_data_plot <- acute_female_AP_data[, c("letter", "state", "peak_amplitude")]

# plot
acute_female_AP_plot <- acute_female_AP_data_plot_df %>%
...
# plot
AM251_female_AP_plot <- AM251_female_AP_data_plot_df %>%
  ggplot(aes(x = state, y = peak_amplitude, group = letter)) +
...
# plot
repeated_female_AP_plot <- repeated_female_AP_data_plot_df %>%
  ggplot(aes(x = state, y = peak_amplitude, group = letter)) +
