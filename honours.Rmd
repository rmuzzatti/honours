...
t_test_male_acute <-perform_t_tests_for_summary_plot(
  data = summary_male_eEPSC_df$summary_data %>% filter(letter %in% c("SW1_MA1", "SW2_MA2", "SW3_MA3", "SW4_MA4", "SW5_MA5", "TW1_MA6", "TW2_MA7", "TW3_MA8")), 
  test_category = 2,
  include_all_treatments = "no",
  list_of_treatments = c("Control"),
  current_type = "eEPSC",
...
plot_percent_change_comparisons(
  data = summary_female_eEPSC_df$percent_change_data,
  plot_category = 2,
  current_type = "eEPSC",
  y_variable = "amplitude",
